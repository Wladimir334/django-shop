...
class Order(models.Model):
    ...
    payment = models.CharField(max_length=50, default='картой', choices=PAYMENT_CHOISES)
    delivery = models.CharField(max_length=50, default='самовывоз из магазина', choices=DELIVERY_CHOISES)
